...
describe "new party page" do
  describe "as a user" do
    describe "when i visit a new party page for some movie", :vcr do
      before do
        @user1 = User.create!(name: "Tony Soprano", email: "woke_up_this_morning@gmail.com", password: 'test', password_confirmation: 'test')
        @user2 = User.create!(name: "Junior Soprano", email: "varsity_athlete@gmail.com", password: 'test', password_confirmation: 'test')
